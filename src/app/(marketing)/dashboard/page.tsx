...
export default function Page() {
  return (
    <main className="w-full min-h-screen">
      ...
      <div className="grid grid-cols-10 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="flex items-start">
                  <div className="flex-1">
                    ...
                    <p className="text-xs text-[#b2b2b2]">Yesterday, 12:30 PM</p>
                  </div>
                  <div className="flex space-x-2">
                    <Button variant="ghost" size="sm" className="h-6 w-6 p-0">
                      <Edit3 className="h-3 w-3 text-[#686868]" />
        ...
        <div className="col-span-4 gap-4 flex flex-col h-full">
          {/* Recently Activity */}
          <Card className="bg-[#161e54] text-white border-none">
            <CardHeader className="pb-2">
  ...
  return (
    <main className="bg-amber-200">
      <h1 className="text-2xl font-bold mb-3 text-[#161E54]">Dashboard</h1>
      ...
      <div className="grid grid-cols-3 gap-6 mb-6">
        <Card className="bg-[#ffefe7] border-none">
          ...
          <CardContent>
            <div className="flex justify-between items-end">
              <div>
                <p className="text-3xl font-bold">24</p>
                <p className="text-xs text-[#ff5151]">4 Urgently needed</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-[#e8f0fb] border-none">
          <CardHeader className="pb-2">
            <h3 className="text-sm font-medium text-[#686868]">Job Open</h3>
          </CardHeader>
          <CardContent>
            <div className="flex justify-between items-end">
              <div>
                <p className="text-3xl font-bold">10</p>
                <p className="text-xs text-[#3786f1]">4 Active hiring</p>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <Card className="bg-[#fdebf9] border-none">
          ...
          <CardContent>
            <div className="flex justify-between items-end">
              <div>
                <p className="text-3xl font-bold">24</p>
                <p className="text-xs text-[#ee61cf]">4 Department</p>
              </div>
            </div>
          </CardContent>
        </Card>
      ...
      <div className="grid grid-cols-12 gap-6">
        {/* Total Employees */}
        <Card className="col-span-4 border-[#e0e0e0]">
          <CardHeader className="pb-2">
            <h3 className="text-sm font-medium text-[#686868]">
              Total Employees
            </h3>
        ...
        {/* Upcoming Schedule */}
        <Card className="col-span-8 border-[#e0e0e0]">
          <CardHeader className="flex flex-row items-center justify-between pb-2">
            <div>
              <h3 className="text-sm font-medium text-[#686868]">
                Upcoming Schedule
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="flex items-start">
                <div className="min-w-[60px]">
                  <p className="text-xs font-medium text-[#686868]">Priority</p>
                </div>
                <div className="flex-1 ml-4">
                  <div className="flex items-center justify-between">
                    <p className="text-sm font-medium">
